	            ...
	            <bean class="com.google.code.kaptcha.util.Config"> 
	                <constructor-arg> 
	                    <props> 
	                        ...
	                        <prop key="kaptcha.word.impl">cn.ptti.portal.web.action.DefaultWordRenderer</prop><!-- 验证码文本字符渲染-->
	                        <prop key="kaptcha.obscurificator.impl">cn.ptti.portal.web.action.FishEyeGimpy</prop><!-- 图片样式  cn.ptti.portal.web.action.FishEyeGimpy鱼眼效果-->
