...
public class CreateBean {
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.user.PointLog_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.user.PointLogEntity"));
        	// 添加接口
      ...
      //把生成的class文件写入文件   
		...
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"user"+File.separator+"PointLog_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.user.UserLoginLog_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.user.UserLoginLogEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"user"+File.separator+"UserLoginLog_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类UserLoginLog_?.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.staff.StaffLoginLog_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.staff.StaffLoginLogEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
	...
	//		e.printStackTrace();
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"staff"+File.separator+"StaffLoginLog_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.message.PrivateMessage_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.message.PrivateMessageEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"message"+File.separator+"PrivateMessage_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.message.SubscriptionSystemNotify_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.message.SubscriptionSystemNotifyEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"message"+File.separator+"SubscriptionSystemNotify_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.message.Remind_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.message.RemindEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"message"+File.separator+"Remind_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.favorite.Favorites_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.favorite.FavoritesEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"favorite"+File.separator+"Favorites_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.favorite.TopicFavorite_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.favorite.TopicFavoriteEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"favorite"+File.separator+"TopicFavorite_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.topic.TopicUnhide_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.topic.UnhideEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"topic"+File.separator+"TopicUnhide_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.user.UserDynamic_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.user.UserDynamicEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"user"+File.separator+"UserDynamic_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.like.Like_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.like.LikeEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"like"+File.separator+"Like_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.like.TopicLike_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.like.TopicLikeEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"like"+File.separator+"TopicLike_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.follow.Follow_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.follow.FollowEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"follow"+File.separator+"Follow_"+tableNumber+".class");
	...
	//    ClassClassPath classPath = new ClassClassPath(this.getClass());
	    ...
	    //通过ClassPool生成一个public新类HistoryOrder.java   
	    CtClass ctClass = pool.makeClass("cn.ptti.portal.bean.follow.Follower_"+tableNumber); 

        try {
        	// 父类
        	ctClass.setSuperclass(pool.get("cn.ptti.portal.bean.follow.FollowerEntity"));
        	// 添加接口
			ctClass.addInterface(pool.get("java.io.Serializable"));
      ...
      //把生成的class文件写入文件   
        ...
        FileOutputStream fos = null;
		try {
			File file = new File(PathUtil.path()+File.separator+"WEB-INF"+File.separator+"classes"+File.separator+"cn.ptti.portal"+File.separator+"bean"+File.separator+"follow"+File.separator+"Follower_"+tableNumber+".class");
