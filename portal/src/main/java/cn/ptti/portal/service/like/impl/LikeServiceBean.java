package cn.ptti.portal.service.like.impl;
...
import cn.ptti.portal.web.action.like.LikeConfig;
import cn.ptti.portal.web.action.like.TopicLikeConfig;
...
public class LikeServiceBean extends DaoSupport<Like> implements LikeService{
	...
	public Like findById(String likeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cn.ptti.portal.bean.like.Like_"+tableNumber);
	...
	public TopicLike findTopicLikeById(String topicLikeId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cn.ptti.portal.bean.like.TopicLike_"+tableNumber);
				Object object  = c.newInstance();
