package cn.ptti.portal.service.favorite.impl;
...
import cn.ptti.portal.web.action.favorite.FavoritesConfig;
import cn.ptti.portal.web.action.favorite.TopicFavoriteConfig;
...
public class FavoriteServiceBean extends DaoSupport<Favorites> implements FavoriteService{
	...
	public Favorites findById(String favoriteId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cn.ptti.portal.bean.favorite.Favorites_"+tableNumber);
	...
	public TopicFavorite findTopicFavoriteById(String topicFavoriteId){
		...
		if(tableNumber == 0){//默认对象
			...
			try {
				//带下划线对象
				Class<?> c = Class.forName("cn.ptti.portal.bean.favorite.TopicFavorite_"+tableNumber);
				Object object  = c.newInstance();
