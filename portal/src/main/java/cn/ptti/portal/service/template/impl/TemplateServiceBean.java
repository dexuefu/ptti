package cn.ptti.portal.service.template.impl;


import cn.ptti.portal.bean.template.Forum;
import cn.ptti.portal.bean.template.Layout;
import cn.ptti.portal.bean.template.TemplateData;
...
//	@Cacheable(value="templateServiceBean_cache",key="#dirName+'_findLayout_'+T(String).valueOf(#type)")
	...
	public List<Forum> findForumByReferenceCodePrefix(String dirName,String referenceCodePrefix){
		...
		//给SQL语句设置参数
		query.setParameter(1, dirName);
		query.setParameter(2, cn.ptti.portal.utils.StringUtil.escapeSQLLike(referenceCodePrefix)+"%");
		return query.getResultList();
